              ...
              <li key={client.id} className="rounded-lg bg-white p-4 shadow-sm">
                <div className="mb-2 flex flex-wrap items-center justify-between gap-2">
                  ...
                  <div className="flex gap-2 text-sm">
                    <button className="bg-slate-100" onClick={() => edit(client)} type="button">Edit</button>
                    <button
                ...
                <div className="mb-2 flex gap-2">
                  ...
                  <button
                    ...
                    onClick={async () => {
                      ...
                      await saveOpportunityToClient(client.id, selectedOpportunityId);
                      await refreshClients();
                    }}
                    type="button"
                  >
                  ...
                  {saved.map((opportunity) => (
                    <li key={opportunity.id} className="flex items-center justify-between rounded border border-slate-200 px-2 py-1">
                      ...
                      <button
                        ...
                        onClick={async () => {
                          await removeOpportunityFromClient(client.id, opportunity.id);
                          await refreshClients();
                        }}
                        type="button"
                      >
